...
public class GPSound extends javax.swing.JFrame {
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(seconds, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(36, 36, 36)))))
                                .addGap(92, 92, 92))))
    ...
    private void updateStartAmp(double n){
        model.setAmplitude(n);
        startAmpSlider.setValue((int)(model.getAmplitude()*100+0.5));
        startAmpValue.setText(String.valueOf((int)(model.getAmplitude()*100+0.5)));
    }
